...
parallelSegment d (WPathBez2 bez) s e =
  ...
  in
    [PathBez2 s (pc+.cVec)]
-- TODO implement for Bezier3. Need to be careful of inflection points and other bad shit
...
strokeTestS = StrokeStyle 10 (BezierJoin 0) (squareCap)
